<template>
  <header class="g-header">
    <div class="m-search-form">
      <input type="text" placeholder="请输入搜索词" v-model="searched_words" @mouseenter="searchContentShow = true" @mouseleave="searchContentShow = false">
      <div class="search-content" @mouseenter="searchContentShow = true" @mouseleave="searchContentShow = false" v-show="searchContentShow && searched_words.length > 1">
            ...
            <ul>
              <li v-for="item in articles_suggestions">
                <div class="article-suggestions-wrapper">
                  <div class="article-suggestions-title" :title="item.origin_title" @click="onSearchedPostClick" v-html="item.title" >
                  </div>
                  <div class="article-suggestions-content" v-html="item.content" :title="item.origin_title" @click="onSearchedPostClick">
                  </div>
                </div>
              </li>
            </ul>
